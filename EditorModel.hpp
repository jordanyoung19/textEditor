...
public:
    ...
    void setLine(int line, std::string newLine);

    void addNewLine(int line);

    void removeLine(int line);

    void addToLineCount();

    void subtractFromLineCount();
...
private:
    ...
    int currentCursorLine; // also known as Y position
    int currentCursorColumn; // also known as X position
    int currentLineCount; //current number of lines (in vector)
    std::vector<std::string> lines;
    std::string errorReport;
    //commandStacks stacks;
